...
if(!empty($_REQUEST["Naam"]) and !empty($_REQUEST["Plaats"]) and !empty($_REQUEST["Datum"]) and !empty($_REQUEST["Uur"]) and !empty($_REQUEST["Beschrijving"]) and !empty($_REQUEST["account_id"])){
    ...
    if($Naam != "undefined" and $Plaats != "undefined" and $Datum != "undefined" and $Uur != "undefined" and $Beschrijving != "undefined" and $account_id != "undefined"){
